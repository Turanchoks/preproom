...
const plans = [
  ...
  },
  {
    ...
    cta: "Contact us",
    ctaHref: "mailto:hello@tutorroom.ai",
    featured: false,
    features: [
      "Up to 10 teachers",
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="mx-auto w-full max-w-6xl px-6 pt-20 pb-16 text-center sm:pt-28">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-balance text-lg text-muted-foreground sm:text-xl">
              TutorRoom gives every learner a persistent teaching agent that
            ...
            <div className="mx-auto mt-16 max-w-5xl">
              <div className="overflow-hidden rounded-xl border border-border bg-card shadow-[0_24px_70px_-32px_rgba(0,0,0,0.45)] ring-1 ring-black/5 dark:ring-white/10">
                <Image
                  alt="The TutorRoom studio — per-student agent chat alongside a student profile panel."
