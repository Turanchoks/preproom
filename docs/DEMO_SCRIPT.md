# TutorRoom — 3-Minute Demo Recording Script
...
**Browser setup**
- [ ] Open Chrome (regular profile) at **https://tutorroom-759438277418.us-central1.run.app**
- [ ] Sign in as **demo@tutorroom.ai** / password **TeachFlow!Demo2026**
...
- [ ] Close all other tabs except the TutorRoom tab
...
**Voiceover:**
> "TutorRoom gives every learner a persistent teaching agent that watches lessons, remembers evidence, and turns it into the next teaching action — automatically. Forty-five minutes of prep, down to zero."
